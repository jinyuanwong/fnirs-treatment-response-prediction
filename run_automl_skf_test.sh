...
model='jamba_MTL'
config_files=(
'MTL_all_hb_simple_all_1d_SPECIFY_FOLD_4_holdout_5_nor_STL_gender_AUG_0'
'MTL_all_hb_simple_all_1d_SPECIFY_FOLD_4_holdout_5_nor_STL_gender_AUG_1'
'MTL_all_hb_simple_all_1d_SPECIFY_FOLD_4_holdout_5_nor_STL_gender_AUG_5'
'MTL_all_hb_simple_all_1d_SPECIFY_FOLD_4_holdout_5_nor_STL_gender_AUG_10'
'MTL_all_hb_simple_all_1d_SPECIFY_FOLD_4_holdout_5_nor_STL_gender_AUG_15'
)
