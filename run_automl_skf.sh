...
model='jamba'
config_file='mdd_classification_all_hb_simple_all_1d_SPECIFY_FOLD_20_holdout_100_nor' #'mdd_classification_all_hb_simple_all_1d_SPECIFY_FOLD_4_holdout_5_nor'
itr_name='skf_20_hold_100' #'eval'
