...
fold = '/Users/shanxiafeng/Documents/Project/Research/fnirs-prognosis/code/fnirs-treatment-response-prediction/allData/jy_process/diagnosis'
DATA =  np.load(fold + '/hb_data_1701_695_830.npy') # np.load('allData/diagnosis/hb_data.npy')
LABEL = np.load(fold + '/label.npy') #  np.load('allData/diagnosis/label.npy')

pre_post_data_combine_type = 'substract'

output_fold = 'FigureTable/statics/timedomain/baseline_dataset_jyProcess_2_695_830'
