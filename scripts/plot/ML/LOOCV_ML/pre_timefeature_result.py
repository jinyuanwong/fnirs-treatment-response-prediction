...
data = {}
timeline = 'pre' # or pre
save_path = f'/Users/shanxiafeng/Documents/Project/Research/fnirs-prognosis/code/fnirs-treatment-response-prediction/FigureTable/timedomain/{timeline}_treatment_hamd_reduction_50'
