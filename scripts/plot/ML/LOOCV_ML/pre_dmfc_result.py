...
Output: 
    {
        ...
        'HbT': [accuracy, sensitivity, specificity, f1]
    }
...
combine_type = 'x'  # 'substract'


output_fold = 'FigureTable/DMFC/pre_treatment_hamd_reduction_50'
...
for machine_learning_name in ['Decision Tree', 'Random Forest', 'KNN', 'SVM']:
    ...
    data_path = f'results/ML_results/DMFC/{timeline}_treatment_hamd_reduction_50/{machine_learning_name}_result.npy'
