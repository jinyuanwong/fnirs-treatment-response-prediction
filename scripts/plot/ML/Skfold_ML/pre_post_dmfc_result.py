...
combine_method = 'substract'

# '{timeline}_treatment_hamd_reduction_50/{machine_learning_name}_result.npy'
input_fold = f'results/ML_results/DMFC/Skfold_CV_DMFC'

output_fold = 'FigureTable/DMFC/Skfold_CV_DMFC/pre_post_treatment_hamd_reduction_50'

if not os.path.exists(output_fold):
    os.makedirs(output_fold)
machine_learning_name = 'SVM'
