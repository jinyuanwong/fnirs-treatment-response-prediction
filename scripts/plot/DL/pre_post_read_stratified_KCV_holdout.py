...
for filename in all_filename:
    cnntr_total_itr = count_lines_in_file(folder_path + '/' + filename + '/' + validation_method + '-' + str(total_fold-1) + '/test_acc.txt')
    print(f'cnntr_total_itr->{cnntr_total_itr}')
    if cnntr_total_itr < 1:
        print("Hello End!")
        continue
