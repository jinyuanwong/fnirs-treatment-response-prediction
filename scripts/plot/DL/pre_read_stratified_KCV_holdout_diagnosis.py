...
model = 'chao_cfnn'  # comb_cnn or cnn_transformer

# 'pre_treatment_hamd_reduction_50' or 'pre_post_treatment_hamd_reduction_50'
# time = '/diagnosis/v1l1_rate_0.01_l2_rate_0.01_d_model_16_batch_size_64_n_layers_6'
time = 'prognosis/pretreatment_benchmarks/v1activation_relu_lr_0.1'
...
test_best_metric = loop_iteration_find_best_performance_id(
    TOTAL_ITR, model, 'test_acc.txt',verbose=False)
print('-'*100)
val_best_metric = loop_iteration_find_best_performance_id(
    TOTAL_ITR, model, 'val_acc.txt',verbose=False)
