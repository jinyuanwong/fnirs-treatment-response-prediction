...
model = 'cnn_transformer'  # comb_cnn or cnn_transformer
...
test_best_metric = loop_iteration_find_best_performance_id(
    cnntr_total_itr, 'cnn_transformer', 'test_acc.txt',verbose=False)
print('-'*100)
val_best_metric = loop_iteration_find_best_performance_id(
    cnntr_total_itr, 'cnn_transformer', 'val_acc.txt',verbose=False)
