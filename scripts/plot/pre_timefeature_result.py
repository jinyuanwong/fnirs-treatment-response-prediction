...
data = {}
timeline = 'pre' # or pre
save_path = f'/Users/shanxiafeng/Documents/Project/Research/fnirs-prognosis/code/fnirs-treatment-response-prediction/FigureTable/TimeFeature/{timeline}_treatment_hamd_reduction_50'
for machine_learning_name in ['Decision Tree', 'Random Forest', 'KNN', 'SVM']:

    data_path = f'/Users/shanxiafeng/Documents/Project/Research/fnirs-prognosis/code/fnirs-treatment-response-prediction/results/ML_results/{timeline}_treatment_hamd_reduction_50/{machine_learning_name}_result.npy'
