...
def loop_find_subs_with_HB(demographic_filepath, hb_filepath):
    ...
    HCS_path = hb_filepath + '/Controls'
    MDD_path = hb_filepath + '/Patients'
...
def get_data(demographic_filepath, hb_filepath):
    ...
    HCS_hb_data = read_hb_data(hb_filepath + '/Controls', HCS_LIST)
    MDD_hb_data = read_hb_data(hb_filepath + '/Patients', MDD_LIST)
...
def main():
    ...
    demographic_data, hb_data, label_data = get_data(demographic_filepath, hb_filepath)
    
    # save data
    np.save(os.path.join(output_fold, 'demographic_data.npy'), demographic_data)
    np.save(os.path.join(output_fold, 'hb_data.npy'), hb_data)
    np.save(os.path.join(output_fold, 'label.npy'), label_data)
