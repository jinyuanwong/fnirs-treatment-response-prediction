"""
Objective: Using 4 different ML models to predict the treatment response of patients with MDD based on functional connectivity data.
"""
...
output_fold = 'results/ML_results/DMFC/pre_treatment_hamd_reduction_50'

input_path = 'allData/prognosis/DMFC/pre_treatment_hamd_reduction_50'
