...
def save_autodl(model_name, feature_selection_method, best_res_metrics, best_seed, iteration_time, para, save_fold, dataset='hb_data'):
    ...
    print(f"Model: {model_name}, Method: {feature_selection_method} is saved!")
...
def get_pretreatment_data_label_demo(dataset='hb_data'):
    pretreatment_path = f'allData/prognosis/pre_treatment_hamd_reduction_50/{dataset}.npy'
    label_path = 'allData/prognosis/pre_treatment_hamd_reduction_50/label.npy'
...
def automl(model_name, feature_selection_method, save_fold, iteration_time, dataset):
    ...
    best_seed = 0
    best_para = ''
    pretreatment_data, pretreatment_label, pretreatment_demo = get_pretreatment_data_label_demo(dataset)
    avg_pretreatment_data = avg_every_ten_point_in_last_dimension(pretreatment_data)
    avg_pretreatment_data = specify_feature_extraction(avg_pretreatment_data, feature_selection_method)
    avg_pretreatment_data = np.reshape(avg_pretreatment_data, (avg_pretreatment_data.shape[0], -1))
    ...
    save_autodl(model_name, feature_selection_method, best_res_metrics, best_seed, iteration_time, para, save_fold, dataset)
