...
def start():
    ...
    avg_pretreatment_data = feature_extraction(avg_pretreatment_data)
    ...
    specify_model_and_train(avg_pretreatment_data, pretreatment_label, 'XGBoost', seed)
...
-------------------------------------------------------------
Using HbO, xgboost_zhu's 10 features, Decision Tree, the accuracy is 0.62, which is not good.
current seed: 1710742431

| Model Name |   Set   |Accuracy | Sensitivity | Specificity | F1 Score |
|------------|----------|----------|-------------|-------------|----------|
| Decision Tree | test | 0.6214 | 0.6000 | 0.6429 | 0.6131 |

-------------------------------------------------------------
Using HbO, zhifei'method to extract features, Decision Tree, the accuracy is 0.57, which is not good.
current seed: 1710742986

| Model Name |   Set   |Accuracy | Sensitivity | Specificity | F1 Score |
|------------|----------|----------|-------------|-------------|----------|
| Decision Tree | test | 0.5786 | 0.5429 | 0.6143 | 0.5630 |

-------------------------------------------------------------
Using HbO, wang_alex's method to extract features, Decision Tree, the accuracy is 0.65, which is slightly better .
current seed: 1710743850

| Model Name |   Set   |Accuracy | Sensitivity | Specificity | F1 Score |
|------------|----------|----------|-------------|-------------|----------|
| Decision Tree | test | 0.6500 | 0.7571 | 0.5429 | 0.6839 |

-------------------------------------------------------------
Using HbO, yu_gnn's method to extract features, Decision Tree, the accuracy is 0.607, which is slightly better .
current seed: 1710744951

| Model Name | Val/Test Set | Accuracy | Sensitivity | Specificity | F1 Score |
|------------|--------------|----------|-------------|-------------|----------|
| Decision Tree | test | 0.6071 | 0.5714 | 0.6429 | 0.5926 |

Combining xgboost_zhu and wang_alex only gets an accuracy of 0.6214, which is not good.

current seed: 1710746142

| Model Name | Val/Test Set | Accuracy | Sensitivity | Specificity | F1 Score |
|------------|--------------|----------|-------------|-------------|----------|
| Decision Tree | test | 0.6214 | 0.5857 | 0.6571 | 0.6074 |


Using XGBoost Combining xgboost_zhu and wang_alex only gets an accuracy of 0.4714, which is not good. 
Define model XGBoost with default setting and seed 1710746445

| Model Name | Val/Test Set | Accuracy | Sensitivity | Specificity | F1 Score |
|------------|--------------|----------|-------------|-------------|----------|
| XGBoost | test | 0.4714 | 0.5000 | 0.4429 | 0.4861 |

Try autoML to see if the performance can be improved. only use the features from xgboost_zhu
