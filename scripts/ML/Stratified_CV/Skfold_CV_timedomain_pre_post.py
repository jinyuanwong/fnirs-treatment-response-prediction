...
output_fold = 'results/ML_results/timedomain/Skfold_CV_DMFC/pre_post_treatment_hamd_reduction_50'

input_path = 'allData/prognosis/pre_post_treatment_hamd_reduction_50'
