...
from utils_simple_prediction import add_task_change_data, load_data_for_classification, add_cgi, add_mddr, set_path
...
def evaluate():
    ...
    for modality_name in ['clinical_data', 'clinical_data_and_fnirs', 'clinical_data_and_mddr', 'clinical_data_and_fnirs_mddr']:
