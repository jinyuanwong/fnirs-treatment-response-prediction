...
def tune_xgboost(data, labels):
    ...
    grid_search = GridSearchCV(estimator=xgb, param_grid=param_grid, scoring=scoring_scorer, cv=CV, verbose=1, n_jobs=-1)
...
def tune_svm(data, labels):
    ...
    # Create the GridSearchCV object
    grid_search = GridSearchCV(estimator=svc, param_grid=param_grid, scoring=scoring_scorer, cv=CV, verbose=1, n_jobs=-1)
...
def tune_gradient_boosting(data, labels):
    ...
    grid_search = GridSearchCV(GradientBoostingClassifier(), param_grid, scoring=scoring_scorer, cv=5, verbose=1, n_jobs=-1)
    grid_search.fit(data, labels)
...
def tune_adaboost(data, labels):
    ...
    grid_search = GridSearchCV(AdaBoostClassifier(), param_grid, scoring=scoring_scorer, cv=5, verbose=1, n_jobs=-1)
    grid_search.fit(data, labels)
...
def tune_knn(data, labels):
    ...
    grid_search = GridSearchCV(KNeighborsClassifier(), param_grid, scoring=scoring_scorer, cv=5, verbose=1, n_jobs=-1)
    grid_search.fit(data, labels)
