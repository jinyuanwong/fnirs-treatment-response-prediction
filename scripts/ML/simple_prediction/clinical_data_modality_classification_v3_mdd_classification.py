...
def classification(data, labels, weight_0=None, partial_response=False):
    ...
    if partial_response is False:
        classifiers = define_classifier_for_mdd_hc_classification(data, labels, weight_0)
    else: 
...
# def choose_modality_for_mdd_hc_classification(modality, partial_response=False):
    
#     data, labels = load_data_for_MDD_HC_classification(modality)
#     save_fold_main = 'results/ML_results/simple_prediction'
#     if partial_response:
#         labels = load_data_for_partial_response_prediction()
#         save_fold_main += '_partial_response'
...
if __name__ == "__main__":
    ...
    train(num_of_repeat=30, partial_response=partial_response, random_seed=time_seed) # random_seed=42
    # evaluate()
