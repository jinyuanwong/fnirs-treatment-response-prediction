...
TOTAL_TIME = 20
output_fold = '/Users/shanxiafeng/Documents/Project/Research/fnirs-prognosis/code/fnirs-treatment-response-prediction/results/ML_results/pre_treatment_hamd_reduction_50'
...
for name, model in models.items():
    ...
    for num_time in range(TOTAL_TIME):
    ...
    np.save(output_fold + f'/{name}_result_20_time.npy', res)