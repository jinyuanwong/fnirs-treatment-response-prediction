...
data_name = 'fNIRS_his_metrics'
X_data = np.concatenate((pro_pyschiatry[:,:9], fnirs_feature), axis=1)
...
# nohup python scripts/fusion_model/fusion_fnirs_his.py > results/fnirs_his.log 2>&1 &