...
PARAMETER_NAME= f'Size={dataSize}'
...
for index, val in enumerate(aug):
    # size - 64
    model_config_dict[val] = [f"Size_Effect_of_Dataset_{seeds[i]}NCV_STL_depression_AUG_0_layers_0_input_dims_128_model_states_128_size_{dataSize}_rep_{val}" for i in range(len(seeds))]
    # head
