...
Val_AUC_Threshold = 0
PARAMETER_NAME='Input Dimension'
# aug = [0, 1, 2, 3]
...
# layer
aug = [1, 2, 3, 5, 7]
# input dimension aug = [16, 32, 64, 128, 256, 512, 1024]
# input dimension aug = [16, 32, 64, 128, 256, 512, 1024]
...
for index, val in enumerate(aug):
    # input dimension
    # model_config_dict[val] = [f"Baseline_Model_{seeds[i]}MTL_Transformer_baseline_d_model_{val}_n_head_1_layer_3" for i in range(len(seeds))]
    # head
