...
for index, val in enumerate(aug):
    ...
    model_config_dict[val] = [f"jamba_20240718_{seeds[i]}STL_depression_NCV_best_v1_wo_mamba_wo_mlp_batch_{val}" for i in range(len(seeds))]
    # head
