...
for index, val in enumerate(aug):
    model_config_dict[val] = [f"MTL_20240710_VF3_AugmentRatio_{seeds[i]}MTL_all_hb_simple_all_1d_NCV_nor_STL_depression_AUG_0_layers_0_input_dims_{val}" for i in range(len(seeds))]
...
for metric, val in metrics.items():
    ...
    print()
    plot_evaluation_metrics_header(table_name = 'Depression', parameter_name='Input Dimension')     
