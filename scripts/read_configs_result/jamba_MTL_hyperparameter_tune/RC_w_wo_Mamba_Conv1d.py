...
aug = ['w_mamba_w_conv1d', 'w_mamba_wo_conv1d', 'wo_mamba_w_conv1d', 'wo_mamba_wo_conv1d']


PARAMETER_NAME= f'Mamba Conv1d influence'
...
for index, val in enumerate(aug):
    ...
    model_config_dict[val] = [f"jamba_20240717_{seeds[i]}NCV_JambaV2_AUG_0_layers_0_best_others_1-Task_depression_wGNN_wMLP_clipnorm_1_weightDecay_0_004_num_layer_0_{val}_dropout_0_3_patience_13" for i in range(len(seeds))]
    # head
