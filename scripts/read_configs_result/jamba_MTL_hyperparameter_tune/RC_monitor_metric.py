...
aug = ['val_loss', 'val_accuracy']


PARAMETER_NAME= f'Monitor Metrics Checkpoint'
...
for index, val in enumerate(aug):
    ...
    model_config_dict[val] = [f"jamba_20240717_{seeds[i]}NCV_STL_depression_best_all_checkpoint_monitor_{val}_begin_patience_15_dropout_rate_0_3" for i in range(len(seeds))]
    # head
