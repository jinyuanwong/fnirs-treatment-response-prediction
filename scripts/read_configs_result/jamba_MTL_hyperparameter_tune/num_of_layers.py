...
for index, val in enumerate(aug):
    model_config_dict[val] = [f"MTL_20240710_VF3_AugmentRatio_{seeds[i]}MTL_all_hb_simple_all_1d_NCV_nor_STL_depression_AUG_0_layers_0_input_dims_64_model_states_{val}" for i in range(len(seeds))]
