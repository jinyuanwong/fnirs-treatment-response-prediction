...
from classifiers.model.RGGCN import ResGatedGCNModel
...
class Classifier_RGGCNN_Transformer():
    def __init__(self, output_directory, callbacks, input_shape, epochs, sweep_config, info):
        ...
        embed_inputs = tf.keras.layers.Dense(units=d_model)(inputs)
        output_1 = ResGatedGCNModel(units=d_model, num_layers=parameter['rggcnn_layers'])(embed_inputs, input_adj)
        output_2 = ResGatedGCNModel(units=d_model, num_layers=parameter['rggcnn_layers'])(embed_inputs, input_adj)
