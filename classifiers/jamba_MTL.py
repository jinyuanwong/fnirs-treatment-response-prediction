...
class Classifier_Jamba():
    def __init__(self, output_directory, callbacks, input_shape, epochs, sweep_config, info):
        ...
        # education_output = layers.Dense(1, name='education')(x)
        ...
        # hamd_scores_output = layers.Dense(1, name='HAMD_Scores')(x)
        ...
        # Create model
        model = Model(inputs=inputs_time_point, outputs=[gender_output, age_output, education_output, smoking_output, alcohol_output, hamd_scores_output, suicide_risk_output, depression_output])
        model.summary()
