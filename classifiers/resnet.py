...
class Classifier_RESNET:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        conv_y = keras.layers.Conv1D(filters=n_feature_maps, kernel_size=8, padding='same')(conv_x)
        ...
        conv_z = keras.layers.Conv1D(filters=n_feature_maps * 2, kernel_size=5, padding='same')(conv_y)
        conv_z = keras.layers.BatchNormalization()(conv_z)
        ...
        shortcut_y = keras.layers.Conv1D(filters=n_feature_maps * 2, kernel_size=1, padding='same')(output_block_2) # mine - delete
        shortcut_y = keras.layers.BatchNormalization()(shortcut_y)#mine -delete
        #shortcut_y = keras.layers.BatchNormalization()(output_block_2) #original
