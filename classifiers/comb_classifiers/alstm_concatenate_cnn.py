...
class Classifier_ALSTM_concatenate_CNN:
    ...
    def CNN(self, channel):
        ...
        m0 = kl.Conv1D(filters=32, kernel_size=self.kernel_size[0], padding=self.padding, activation=self.activation)(
            channel)

        m0 = kl.Conv1D(filters=32, kernel_size=self.kernel_size[1], padding=self.padding, activation=self.activation)(
            m0)
    ...
    def ALSTM_concatanate_CNN(self,Channel):

        alstm = self.ALSTM(Channel)

        #CNN
        cnn = self.CNN(Channel)

        alstm_cnn = kl.concatenate([alstm,cnn])

        m = km.Model(inputs=Channel, outputs=alstm_cnn)
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        if self.useCombinationModel == True:
            ...
            m0 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m1 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m2 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m3 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m4 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m5 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m6 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m7 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m8 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m9 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m10 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m11 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m12 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m13 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m14 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m15 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m16 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m17 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m18 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m19 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m20 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m21 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m22 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m23 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m24 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m25 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m26 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m27 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m28 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m29 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m30 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m31 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m32 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m33 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m34 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m35 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m36 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m37 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m38 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m39 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m40 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m41 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m42 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m43 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m44 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m45 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m46 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m47 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m48 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m49 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m50 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
            m51 = self.ALSTM_concatanate_CNN(kl.Input(input_shape))
