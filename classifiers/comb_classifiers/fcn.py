...
class Classifier_FCN:
    ...
    def FCN(self,channel):
        ...
        fcn = km.Model(inputs=channel, outputs=fcn)
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        if self.useCombinationModel == True:
            ...
            m0 = self.FCN(kl.Input(input_shape))
            m1 = self.FCN(kl.Input(input_shape))
            m2 = self.FCN(kl.Input(input_shape))
            m3 = self.FCN(kl.Input(input_shape))
            m4 = self.FCN(kl.Input(input_shape))
            m5 = self.FCN(kl.Input(input_shape))
            m6 = self.FCN(kl.Input(input_shape))
            m7 = self.FCN(kl.Input(input_shape))
            m8 = self.FCN(kl.Input(input_shape))
            m9 = self.FCN(kl.Input(input_shape))
            m10 = self.FCN(kl.Input(input_shape))
            m11 = self.FCN(kl.Input(input_shape))
            m12 = self.FCN(kl.Input(input_shape))
            m13 = self.FCN(kl.Input(input_shape))
            m14 = self.FCN(kl.Input(input_shape))
            m15 = self.FCN(kl.Input(input_shape))
            m16 = self.FCN(kl.Input(input_shape))
            m17 = self.FCN(kl.Input(input_shape))
            m18 = self.FCN(kl.Input(input_shape))
            m19 = self.FCN(kl.Input(input_shape))
            m20 = self.FCN(kl.Input(input_shape))
            m21 = self.FCN(kl.Input(input_shape))
            m22 = self.FCN(kl.Input(input_shape))
            m23 = self.FCN(kl.Input(input_shape))
            m24 = self.FCN(kl.Input(input_shape))
            m25 = self.FCN(kl.Input(input_shape))
            m26 = self.FCN(kl.Input(input_shape))
            m27 = self.FCN(kl.Input(input_shape))
            m28 = self.FCN(kl.Input(input_shape))
            m29 = self.FCN(kl.Input(input_shape))
            m30 = self.FCN(kl.Input(input_shape))
            m31 = self.FCN(kl.Input(input_shape))
            m32 = self.FCN(kl.Input(input_shape))
            m33 = self.FCN(kl.Input(input_shape))
            m34 = self.FCN(kl.Input(input_shape))
            m35 = self.FCN(kl.Input(input_shape))
            m36 = self.FCN(kl.Input(input_shape))
            m37 = self.FCN(kl.Input(input_shape))
            m38 = self.FCN(kl.Input(input_shape))
            m39 = self.FCN(kl.Input(input_shape))
            m40 = self.FCN(kl.Input(input_shape))
            m41 = self.FCN(kl.Input(input_shape))
            m42 = self.FCN(kl.Input(input_shape))
            m43 = self.FCN(kl.Input(input_shape))
            m44 = self.FCN(kl.Input(input_shape))
            m45 = self.FCN(kl.Input(input_shape))
            m46 = self.FCN(kl.Input(input_shape))
            m47 = self.FCN(kl.Input(input_shape))
            m48 = self.FCN(kl.Input(input_shape))
            m49 = self.FCN(kl.Input(input_shape))
            m50 = self.FCN(kl.Input(input_shape))
            m51 = self.FCN(kl.Input(input_shape))
