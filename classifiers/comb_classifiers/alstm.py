...
class Classifier_ALSTM:
    ...
    def Attention_LSTM(self,Channel):
        ...
        m = km.Model(inputs=Channel, outputs=alstm)
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        if self.useCombinationModel == True:
            ...
            m0 = self.Attention_LSTM(kl.Input(input_shape))
            m1 = self.Attention_LSTM(kl.Input(input_shape))
            m2 = self.Attention_LSTM(kl.Input(input_shape))
            m3 = self.Attention_LSTM(kl.Input(input_shape))
            m4 = self.Attention_LSTM(kl.Input(input_shape))
            m5 = self.Attention_LSTM(kl.Input(input_shape))
            m6 = self.Attention_LSTM(kl.Input(input_shape))
            m7 = self.Attention_LSTM(kl.Input(input_shape))
            m8 = self.Attention_LSTM(kl.Input(input_shape))
            m9 = self.Attention_LSTM(kl.Input(input_shape))
            m10 = self.Attention_LSTM(kl.Input(input_shape))
            m11 = self.Attention_LSTM(kl.Input(input_shape))
            m12 = self.Attention_LSTM(kl.Input(input_shape))
            m13 = self.Attention_LSTM(kl.Input(input_shape))
            m14 = self.Attention_LSTM(kl.Input(input_shape))
            m15 = self.Attention_LSTM(kl.Input(input_shape))
            m16 = self.Attention_LSTM(kl.Input(input_shape))
            m17 = self.Attention_LSTM(kl.Input(input_shape))
            m18 = self.Attention_LSTM(kl.Input(input_shape))
            m19 = self.Attention_LSTM(kl.Input(input_shape))
            m20 = self.Attention_LSTM(kl.Input(input_shape))
            m21 = self.Attention_LSTM(kl.Input(input_shape))
            m22 = self.Attention_LSTM(kl.Input(input_shape))
            m23 = self.Attention_LSTM(kl.Input(input_shape))
            m24 = self.Attention_LSTM(kl.Input(input_shape))
            m25 = self.Attention_LSTM(kl.Input(input_shape))
            m26 = self.Attention_LSTM(kl.Input(input_shape))
            m27 = self.Attention_LSTM(kl.Input(input_shape))
            m28 = self.Attention_LSTM(kl.Input(input_shape))
            m29 = self.Attention_LSTM(kl.Input(input_shape))
            m30 = self.Attention_LSTM(kl.Input(input_shape))
            m31 = self.Attention_LSTM(kl.Input(input_shape))
            m32 = self.Attention_LSTM(kl.Input(input_shape))
            m33 = self.Attention_LSTM(kl.Input(input_shape))
            m34 = self.Attention_LSTM(kl.Input(input_shape))
            m35 = self.Attention_LSTM(kl.Input(input_shape))
            m36 = self.Attention_LSTM(kl.Input(input_shape))
            m37 = self.Attention_LSTM(kl.Input(input_shape))
            m38 = self.Attention_LSTM(kl.Input(input_shape))
            m39 = self.Attention_LSTM(kl.Input(input_shape))
            m40 = self.Attention_LSTM(kl.Input(input_shape))
            m41 = self.Attention_LSTM(kl.Input(input_shape))
            m42 = self.Attention_LSTM(kl.Input(input_shape))
            m43 = self.Attention_LSTM(kl.Input(input_shape))
            m44 = self.Attention_LSTM(kl.Input(input_shape))
            m45 = self.Attention_LSTM(kl.Input(input_shape))
            m46 = self.Attention_LSTM(kl.Input(input_shape))
            m47 = self.Attention_LSTM(kl.Input(input_shape))
            m48 = self.Attention_LSTM(kl.Input(input_shape))
            m49 = self.Attention_LSTM(kl.Input(input_shape))
            m50 = self.Attention_LSTM(kl.Input(input_shape))
            m51 = self.Attention_LSTM(kl.Input(input_shape))
