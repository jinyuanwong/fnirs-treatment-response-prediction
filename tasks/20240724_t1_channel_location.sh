...
config_names=(
    'STL_depression_NCV_best_v4_Z1_channel-combine'
    'STL_depression_NCV_best_v4_Z1_channel-last'
    'STL_depression_NCV_best_v4_Z1_channel-first'
)
run_itr='jamba_20240724'
